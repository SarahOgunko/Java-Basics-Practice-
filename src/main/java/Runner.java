...
//        System.out.println("The rectangle has an area of " + area);
        ...
        boolean isRectangle = rectangle.checkSquare();
    ...
    public static void computerDemo(){
        ...
        Computer computer = new Computer(600, "not connected");
      ...
      int newStorage = computer.getMoreStorage();
      System.out.println("Computer now has " + newStorage + "GB storage");
        ...
        String currentPrinter = computer.setUpdatePrinter();
